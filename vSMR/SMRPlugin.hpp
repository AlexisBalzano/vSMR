...
#define MY_PLUGIN_VERSION   "v1.0.9"
#define MY_PLUGIN_DEVELOPER "Pierre Ferran, Even Rognlien, Lionel Bischof, Daniel Lange, Juha Holopainen, Keanu Czirjak, French vACC"
